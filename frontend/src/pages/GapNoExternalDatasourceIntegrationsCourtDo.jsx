...
export default function GapNoExternalDatasourceIntegrationsCourtDo() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-external-datasource-integrations-court-do', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No external data-source integrations (court dockets, property tax APIs)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIPublicRecordsSearchAgent - Gap feature</p>
