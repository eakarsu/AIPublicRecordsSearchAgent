...
export default function GapNoBulkDownloadexportOfResults() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-bulk-downloadexport-of-results', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No bulk download/export of results</h1>
