...
const FEATURE_SLUG = 'no-external-datasource-integrations-court-do';
const FEATURE_TITLE = 'No external data-source integrations (court dockets, property tax APIs)';
const PROJECT = 'AIPublicRecordsSearchAgent';
